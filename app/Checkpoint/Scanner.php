...
final class Scanner
{
    private const APPLICATION_CHECK_NAMESPACE = 'App\\Checkpoint\\Checks\\';
    ...
    public static function withDefaultChecks(string $basePath): static
    {
        ...
        foreach ($enabled as $class => $isEnabled) {
            if ($isEnabled === false || ! is_string($class) || ! str_starts_with($class, self::APPLICATION_CHECK_NAMESPACE)) {
                continue;
            }
